...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x286cfa668c097;
...
const size_t   CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE     = 40000; //size of block (bytes) after which reward for block calculated using block size
...
const char     CRYPTONOTE_NAME[]                             = "slowchain";
